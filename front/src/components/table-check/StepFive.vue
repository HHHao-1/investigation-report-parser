...
export default {
  ...
  watch: {
    tableData1: {
      handler: function () {
        ...
        this.canNext = (this.tableData1[0].coinPair || 'e') !== 'e'
            && (this.tableData1[0].amount || 'e') !== 'e'
            && (this.tableData1[0].price || 'e') !== 'e'
            && (this.tableData1[0].time || 'e') !== 'e'
            && (this.tableData2[0].coinPair || 'e') !== 'e'
            && (this.tableData2[0].amount || 'e') !== 'e'
            && (this.tableData2[0].price || 'e') !== 'e'
  ...
  mounted() {
    ...
    if (!this.editable && (sessionStorage.getItem('checkData') || 'e') !== 'e') {
      this.tableData1 = JSON.parse(sessionStorage.getItem('checkData')).exchangeBuyList
      this.tableData2 = JSON.parse(sessionStorage.getItem('checkData')).exchangeSellList
    }
  },
  methods: {
    format(row, column) {
